...
def training_kd(args, train_path, writer, epochs, model, modelTea, train_loader, valid_loader, optimizer, loss_fn, lr_scheduler):
    ...
    for epoch in range(1, epochs + 1):
        ...
        for i, data in enumerate(tqdm(train_loader)):
            ...
            with torch.no_grad():
                _,fT,outputT = modelTea(img)
                if args.Ukd == "Decode":
                    fT = fT[7-args.KDlayers:]
...
if __name__ == "__main__":
    ...
    netTea.load_state_dict(torch.load("model_KIS/transUnet/Train_bs12_lr0.005_256_s42/best_model_85.20_3.60.pth",
    ...
    train_path = "model_KIS/{}/{}".format(args.model,args.kd)
    ...
    history = training_kd(args, train_path, writer, epochs, net, netTea, train_loader, test_loader, optimizer, loss_fn, lr_scheduler) 
